 ...
 * 项目名称:Yearn 文件名称:ActionVTStatus.scala
...
/**
  ...
  */
abstract class ActionVTStatus extends TAction with V2args {
  val statusObj: VC
  override val obj: TThing = statusObj



  override def genArgInf: Set[TPred] = argInfV2argsFunc[TIb,VC](sbj,statusObj)
}
