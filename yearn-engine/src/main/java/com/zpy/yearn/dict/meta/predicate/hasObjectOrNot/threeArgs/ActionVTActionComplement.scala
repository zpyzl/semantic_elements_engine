 ...
 * 项目名称:Yearn 文件名称:ActionVTActionComplement.scala
...
/**
  ...
  */
abstract class ActionVTActionComplement extends ActionVT with V3args {
  ...
  override def genArgInf: Set[TPred] = argInfV3argsFunc[TIb,TThing,TAction](actor,obj,actionComplement)
}
