 ...
 * 项目名称:Yearn 文件名称:ActionVTComplement.scala
...
/**
  ...
  */
abstract class ActionVTComplement extends ActionVT with V3args {
  ...
  override def genArgInf: Set[TPred] = argInfV3argsFunc[TIb,TThing,TPred](sbj,obj,complement)
}
